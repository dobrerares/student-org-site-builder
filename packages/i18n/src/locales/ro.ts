...
export const ro: RomanianCatalog = {
  ...
  "addBlock.category.mandatory": "Esențiale",
  "addBlock.category.mandatory.hint": "Majoritatea paginilor au nevoie de ele.",
  "addBlock.category.optional": "Mai multe secțiuni",
  "addBlock.category.optional.hint": "Alege ce se potrivește paginii tale.",
  "addBlock.category.advanced": "Pentru experți",
  "addBlock.category.advanced.hint": "Doar dacă te ajută cineva tehnic.",
  "addBlock.category.custom": "Din pachetele tale de temă",
  "addBlock.category.custom.hint": "Secțiuni adăugate de un dezvoltator pentru acest site.",
  "form.list.item": "element",
  "form.list.add": "Adaugă {item}",
  "form.list.itemActions": "Acțiuni pentru {list} {item} {index}",
  "form.image.description": "Descrierea imaginii (pentru cititoare de ecran)",
  "packages.update.preview.yes": "Da",
  "packages.update.preview.no": "Nu",
  "packages.update.preview.entries": "{count, plural, one {# intrare} other {# intrări}}",
  "packages.update.preview.richText": "text formatat",
  "packages.update.preview.linkPage": "o legătură către o pagină",
  "packages.update.preview.linkArticle": "o legătură către un articol",
  "packages.update.preview.group": "un grup de valori",
  "articles.info":
  ...
  "export.omitted.info":
    "Aceste blocuri nu vor apărea pe site-ul exportat, pentru că această temă nu are un design pentru ele. Conținutul rămâne salvat; o temă care are un design pentru ele le afișează din nou.",
