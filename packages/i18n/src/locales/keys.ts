...
export type EditorMessageKey =
  ...
  | "richText.toolbar.underline"
  | "richText.toolbar.strike"
  | "richText.toolbar.code"
  | "richText.toolbar.paragraph"
  | "richText.toolbar.heading2"
  | "richText.toolbar.heading3"
  | "richText.toolbar.heading4"
  | "richText.toolbar.bulletList"
  | "richText.toolbar.orderedList"
  | "richText.toolbar.blockquote"
  | "richText.toolbar.link"
  | "richText.toolbar.unlink"
  | "richText.toolbar.image"
  | "richText.toolbar.undo"
  | "richText.toolbar.redo"
  | "richText.link.title"
  | "richText.link.description"
  | "richText.link.tab.internal"
  | "richText.link.tab.external"
  | "richText.link.search.label"
  | "richText.link.search.placeholder"
  | "richText.link.search.empty"
  | "richText.link.kind.page"
  | "richText.link.kind.article"
  | "richText.link.draftWarning"
  | "richText.link.external.label"
  | "richText.link.external.placeholder"
  | "richText.link.external.help"
  | "richText.link.external.invalid"
  | "richText.link.action.apply"
  | "richText.link.action.remove"
  | "richText.link.action.cancel"
  | "richText.link.selectionRequired"
  | "richText.image.title"
  | "richText.image.description"
  | "richText.image.alt.label"
  ...
  | "customBlock.provided"
  | "customBlock.field.required"
  | "blocks.row.unavailable"
  | "link.field.target"
  | "link.field.none"
  | "link.field.external"
  | "link.field.pages"
  ...
  | "link.field.missing.option"
  | "link.field.missing.page"
  | "link.field.missing.article"
  | "link.field.draftOption"
  | "link.field.draft"
  | "packages.update.title"
  | "packages.update.intro"
  | "packages.update.keep"
  | "packages.update.entry"
  | "packages.update.cancel"
  | "packages.update.confirm"
  | "packages.restore"
  | "packages.restore.hint"
  | "packages.provides"
  | "addBlock.category.mandatory"
  | "addBlock.category.mandatory.hint"
  | "addBlock.category.optional"
  | "addBlock.category.optional.hint"
  | "addBlock.category.advanced"
  | "addBlock.category.advanced.hint"
  | "addBlock.category.custom"
  | "addBlock.category.custom.hint"
  | "form.list.item"
  | "form.list.add"
  | "form.list.itemActions"
  | "form.image.description"
  | "packages.update.preview.yes"
  | "packages.update.preview.no"
  | "packages.update.preview.entries"
  | "packages.update.preview.richText"
  | "packages.update.preview.linkPage"
  | "packages.update.preview.linkArticle"
  | "packages.update.preview.group"
  | "articles.info"
  | "theme.info"
  | "settings.info"
  | "overview.title"
