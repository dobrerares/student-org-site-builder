...
// ---------------------------------------------------------------------------
// generateDeployMd: bilingual user-facing handoff generator (issue #43).
// Keeps the placeholder `DEPLOY_MD` above for the export.ts import site;
// the export pipeline can swap to `generateDeployMd` when it picks up an
// editor-language signal. Both surfaces are exported.
// ---------------------------------------------------------------------------
