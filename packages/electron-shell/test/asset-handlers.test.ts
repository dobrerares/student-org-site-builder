  ...
  return {
    async processAssetForVariants(request: ProcessAssetForVariantsRequest) {
      return {
        ...
        variants: [
          { requestedWidth: 400, width: 400, height: 225, mime: "image/webp" as const, bytes: new Uint8Array([0]) },
          { requestedWidth: 800, width: 800, height: 450, mime: "image/webp" as const, bytes: new Uint8Array([0]) },
          { requestedWidth: 1600, width: 1600, height: 900, mime: "image/webp" as const, bytes: new Uint8Array([0]) },
        ],
