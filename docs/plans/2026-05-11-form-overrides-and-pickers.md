...
**Why this matters:** Per CONTEXT.md's revised Site spine: "Everything in the Site schema *except* `pages[].blocks` **and `theme`**". The ThemeForm (T6) handles theme; SpineForm must not also render it.
