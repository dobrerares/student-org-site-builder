...
- **Interactive preview mode** ([ADR 0056](adr/0056-interactive-preview-isolation.md)),
  the editor toggle that turns `includePublicScript` on so `public.js` can be
  exercised without leaving the editor.
